...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_only', action='store_true', help='Run evaluation or feature extraction only (no training).')
    parser.add_argument('--eval_visual_openset', action='store_true', help='With --eval_only: visual open-set evaluation.')
    parser.add_argument('--eval_get_content_features', action='store_true', help='With --eval_only: save content features only.')
    parser.add_argument('--config', type=str, default='configs/base.yaml', help='YAML config path.')
    parser.add_argument('--data_json', type=str, default='ROOTPATH_ANNOTATION/in-domain/seen/InsA_train_seen_seed777.json', help='COCO-format JSON for train/eval.')
    parser.add_argument('--WANDB', action='store_true', help='Log training to Weights & Biases.')
    parser.add_argument('--wandb_usr_name', type=str, default='', help='W&B entity or username.')
    parser.add_argument('--wandb_key', type=str, default='', help='W&B API key (optional if already logged in).')
